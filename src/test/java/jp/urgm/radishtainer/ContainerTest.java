...
public class ContainerTest {
	...
	public void getComponent() throws Exception {
		final Container container = new ContainerBuilder().register(Aaa.class).build();
	...
	public void getComponentSingleton() throws Exception {
		final Container container = new ContainerBuilder().register(Bbb.class).build();
	...
	public void constructorInjection() throws Exception {
		final Container container = new ContainerBuilder().register(Ccc1.class).register(Ccc2.class).build();
	...
	public void fieldInjection() throws Exception {
		final Container container = new ContainerBuilder().register(Ccc1.class).register(Ccc3.class).build();
		final Ccc1 component1 = container.getComponent(Ccc1.class);
	...
	public void methodInjection() throws Exception {
		final Container container = new ContainerBuilder().register(Ccc1.class).register(Ccc4.class).build();
		final Ccc1 component1 = container.getComponent(Ccc1.class);
	...
	public void getComponentByInterface() throws Exception {
		final Container container = new ContainerBuilder().register(Ddd2.class).build();
	...
	public void getComponentBySuperclass() throws Exception {
		final Container container = new ContainerBuilder().register(Eee2.class).build();
	...
	public void qualifier() throws Exception {
		final Container container = new ContainerBuilder().register(Fff2.class).register(Fff3.class).build();
	...
	public void qualifierGetComponentByType() throws Exception {
		final Container container = new ContainerBuilder().register(Fff2.class).build();
		final Fff1 component1 = container.getComponent(Fff1.class, new NamedImpl("foo"));
	...
	public void constructorInjectionWithQualifier() throws Exception {
		final Container container = new ContainerBuilder().register(Ggg2.class)
			.register(Ggg3.class)
			.register(Ggg4.class)
			.build();
	...
	public void constructorInjectionAsProvider() throws Exception {
		final Container container = new ContainerBuilder().register(Hhh1.class).register(Hhh2.class).build();
	...
	public void fieldInjectionAsProvider() throws Exception {
		final Container container = new ContainerBuilder().register(Hhh1.class).register(Hhh3.class).build();
		final Hhh1 component1 = container.getComponent(Hhh1.class);
	...
	public void methodInjectionAsProvider() throws Exception {
		final Container container = new ContainerBuilder().register(Hhh1.class).register(Hhh4.class).build();
		final Hhh1 component1 = container.getComponent(Hhh1.class);
	...
	public void fieldInjectionSuperclass() throws Exception {
		final Container container = new ContainerBuilder().register(Iii1.class).register(Iii3.class).build();
	...
	public void methodInjectionSuperclass() throws Exception {
		final Container container = new ContainerBuilder().register(Iii1.class).register(Iii5.class).build();
		final Iii1 component1 = container.getComponent(Iii1.class);
	...
	public void methodInjectionOverride() throws Exception {
		final Container container = new ContainerBuilder().register(Iii1.class).register(Iii7.class).build();
		final Iii1 component1 = container.getComponent(Iii1.class);
